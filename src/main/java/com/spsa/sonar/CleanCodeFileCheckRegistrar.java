...
public class CleanCodeFileCheckRegistrar implements CheckRegistrar {
    ...
    public void register(RegistrarContext registrarContext) {
        registrarContext.registerClassesForRepository(CleanCodeRulesDefinition.REPOSITORY_KEY, Arrays.asList(checkClasses()),
    ...
    public static Class<? extends JavaCheck>[] checkClasses() {
        return new Class[] { AvoidPublicBooleanParameterRule.class, AvoidMultipleParameterRule.class, AvoidNullCheckInPrivateMethodRule.class,PrivateMethodPositionRule.class };
    }
